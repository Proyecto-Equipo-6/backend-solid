...
(async function flujoCompleto() {
  ...
  try {
    ...
    console.log('1. Login OK (juan@email.com)');
    ...
    console.log(`3. Detalle abierto (${await driver.getCurrentUrl()})`);
    ...
    console.log(`4. Producto agregado al carrito: "${await alertaExito.getText()}"`);
  } catch (err) {
